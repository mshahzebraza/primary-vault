...
- [ ] **[ID 22] [[260423T0904 (Thu) Timezone Dropdown List adjustments based on Daylight Savings]]**
...
- [x] **[ID 26] Remove (Default) from the Role on the frontend on Settings > Team**
  - **Category:** Bug | **Severity:** Nice
  - **Comments:** SO minor, but remove (Default) for now, since they are ALL default

- **[ID 27] Auto log out if ONE tab is inactive, even if using another tab** (QA Failed in prod for normal timeout)
  - **Category:** Bug | **Severity:** Nice
