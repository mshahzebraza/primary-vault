...
- Proposed & Rejected: Allow University Admins to create their own templates
	...
	- At regular intervals, tech support will analyze the list of Program Templates owned by the universities, and promote them to scholarship ownership to be displayed to all clients
