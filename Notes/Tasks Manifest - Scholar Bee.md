...
- [ ] [[260605 Task - Search Engine Issues Post Eid]]
...
- [ ] [[260424 Task - Signup parity for Google OAuth callback (required fields)]]
...
- [ ] [[260424 Task - Admission status offload to frontend (derive openSoon etc)]]
...
- [x] [[260428 BUG - Notifications for recent admission programs not generated in db]] (Not Pushed)
- [x] [[260428 Bug - Scheduled Emails are not sent to admins regarding missed replies]] (Not Pushed)
- [x] [Transcript and ID Card Fields Are Not Mandatory in Application Form](https://scholarbee-team.atlassian.net/browse/SB-1417)
- [x] [[260416 Admission Program Details - Session Term Filtering & "Latest Term" Query Parameter]]
- [x] [[260420 Update Admission Program Filtering - Replace University Slug with Campus Slug]]
...
- [x] [[260425 Task - Onboarding preferences + self-update endpoint]]
- [x] [[260507 Task - Admission Program Lifecycle & Term based Archiving]] (CMS PR #25)
- [x] [[260424 Task - Backend: admission dates + receivingApplication + status (rich filters + app draft & submit]] (backend PR #57, #44)
- [x] [[260424 Task - CMS portal strict validation for admissions receivingApplication fields]] (CMS PR #20, #25)
...
- [ ] [[260423 Send reminder emails to support persons for delayed replies|Nightly email — unread student messages (all admins, inc. support)]]
